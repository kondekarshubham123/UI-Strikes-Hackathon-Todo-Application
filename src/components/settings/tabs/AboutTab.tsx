  ...
  return (
    <>
      ...
      <Typography variant="caption" sx={{ display: "block", mt: 2 }}>
        Created by <Link href="https://github.com/kondekarshubham123">kondekarshubham123</Link> <br />
        Explore the project on GitHub:{" "}
        <Link href="https://github.com/kondekarshubham123/UI-Strikes-Hackathon-Todo-Application" target="_blank" rel="noopener noreferrer">
          Todo App Repository
        </Link>
      </Typography>
