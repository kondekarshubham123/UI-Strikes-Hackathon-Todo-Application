...
const template = ({ width, height, mode }) => {
  ...
  return `
     <html>
      ...
      <body>
        <div class="container">
          <img src="https://raw.githubusercontent.com/kondekarshubham123/TodoApp/refs/heads/main/public/logo.svg" class="logo" alt="App Logo" />
          <div class="app-name">
        ...
        <div class="attribution">
          ...
          <div class="attribution-box">
            <img src="https://avatars.githubusercontent.com/u/85953204?v=4" alt="@kondekarshubham123" />
            <span>@kondekarshubham123</span>
          </div>
        </div>
      </body>
    </html>
